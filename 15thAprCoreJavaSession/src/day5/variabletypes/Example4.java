...
public class Example4 
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("STD Global varibale x: "+Example4.x);
		System.out.println("STD Global varibale y: "+Example4.y);
		Example4.y=Example4.x+num1;
		//y=x+num1;
		System.out.println("updated, STD Global varibale y: "+Example4.y);
